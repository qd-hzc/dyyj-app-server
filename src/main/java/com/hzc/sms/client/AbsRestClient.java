 ...
 * @project rest_demo
 */
package com.hzc.sms.client;

import com.hzc.sms.EncryptUtil;
import com.hzc.sms.SSLHttpClient;
import com.hzc.sms.SysConfig;
...
public abstract class AbsRestClient {
	...
	public String server="https://api.ucpaas.com";//SysConfig.getInstance().getProperty("rest_server");
	 ...
	 * sendSms
	 */
	public abstract String sendSms(String accountSid, String authToken, String appId, String templateId, String to, String param) throws Exception;
