...
<div class="alert alert-info">
    <i class="icon-hand-right"></i>
    注意事项：APP打开后即开始计时，变为后台任务后即暂停计时。
    默认第一次安装后大部分内容为收费内容，当管理员在此修改了手机号对应用户的”可用时长“后，当用户下一次打开此APP后才可生效（可以这么模拟：从任务管理器删除此任务，再打开APP）。
    <%--<br>--%>
    <%--模糊查询和其他管理模块，我会一个一个的做。。--%>
    <button class="close" data-dismiss="alert">
        <i class="icon-remove"></i>
...
<script type="text/javascript">
    var searchUrl = Routers.topEnglish.empower.searchList;
