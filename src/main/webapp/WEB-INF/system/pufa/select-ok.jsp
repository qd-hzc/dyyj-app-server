...
<div class="row">
  ...
  <div class="col-sm-10" style="background:#d0f6e3!important;padding-left: 0px;padding-right: 0px;border-left: 1px solid #cccccc;border-right:1px solid #cccccc;">
    ...
    <div class="main-container" id="main-container" style="">
          <div class="ss"><span style="color:red;float:left;margin-left:50px;">您已经选择了下面N位闭卷考试人员 </div>
      ...
      <ul><li><a class="button blue" style="color:white!important;text-align: center;"
                 href="CommonCtrl.goTo.do?path=/WEB-INF/system/pufa/generate-prompt.jsp"><strong>批量生成准考证</strong></a></li>
        <li><a class="button blue" style="width:140px!important;color:white!important;text-align: center;"
               href="CommonCtrl.goTo.do?path=/WEB-INF/system/pufa/select-card.jsp"><strong>返&nbsp;&nbsp;&nbsp;&nbsp;回</strong></a></li></ul>
    </div>
    <!-- /.main-container -->
