  ...
  <div class="col-sm-10" style="background:#d0f6e3!important;padding-left: 0px;padding-right: 0px;border-left: 1px solid #cccccc;border-right:1px solid #cccccc;">
    ...
    <div class="main-container" id="main-container" style="">
        ...
        <div id="main-content-id" class="main-content" style="margin-left:0px;margin-top: 10px;">
          <div class="page-content" style="background:none!important;min-height:250px;text-align: center;">
            ...
            <div class="row"style="margin-top: 100px;">
              ...
              <div class="col-sm-4"  style="font-family:微软雅黑;font-size: 20px;line-height:48px;text-align: left;padding-left:30px;">
                  您的姓名:&nbsp;<input name="username" type="text"  value="XXX"style="border:1px solid #1687d5; width:290px;"><br/>
                  出生日期:&nbsp;<input name="userborn" type="text"  value="1980.10.10"style="border:1px solid #1687d5; width:290px;"><br/>
                  工作单位:&nbsp;<input name="usercompany" type="text"  value="李沧区人社局"style="border:1px solid #1687d5; width:290px;"><br/>
                  您的职级:&nbsp;<input name="userrank" type="text"  value="正科"style="border:1px solid #1687d5; width:290px;"><br/>
                </div>
              <!--右边-->
              <div class="col-sm-4">
                <form action="" method="post" style="font-family:微软雅黑;font-size: 20px;line-height:48px;text-align: left;padding-left:30px;">
                  您的性别:&nbsp;<input name="sex" id="man" type="radio" value="" checked="checked/>
                  ...
                  身份证号:&nbsp;<input name="userborn" type="text" value="123456789123456789" style="border:1px solid #1687d5; width:290px;"><br/>
                  手机号码:&nbsp;<input name="usercompany" type="text" value="12345678912" style="border:1px solid #1687d5; width:290px;"><br/>
      ...
      <!-- /.main-container-inner -->
         ...
         href="CommonCtrl.goTo.do?path=/WEB-INF/system/pufa/exam-Information.jsp"><strong>确定修改</strong></a>
    <!-- /.main-container -->
