...
!function (a, b) {
    ...
    var c = function (a, b) {
        ...
        a.gestures.touch = {
            ...
            start: {x: d.pageX, y: d.pageY},
            flickStart: {x: d.pageX, y: d.pageY},
            flickDistanceX: 0,
            flickDistanceY: 0,
            move: {x: 0, y: 0},
            deltaX: 0,
    ...
    b.addEventListener(a.EVENT_START, g), b.addEventListener(a.EVENT_MOVE, h), b.addEventListener(a.EVENT_END, i), b.addEventListener(a.EVENT_CANCEL, i), b.addEventListener(a.EVENT_CLICK, function (b) {
        ...
        this.each(function () {
            ...
            e.addEventListener(b, function (b) {
                ...
                if (f && f.length > 0)for (; g && g !== document && g !== e; g = g.parentNode)g && ~f.indexOf(g) && (b.detail ? b.detail.currentTarget = g : b.detail = {currentTarget: g}, d.call(g, b))
    ...
    a.registerGesture({name: b, index: 20, handle: c, options: {}})
    ...
    a.registerGesture({
        ...
        index: 30,
        handle: c,
        options: {tapMaxInterval: 300, tapMaxDistance: 5, tapMaxTime: 250}
    })
    ...
    a.registerGesture({name: b, index: 10, handle: d, options: {holdTimeout: 0}})
}(mui, "hold"), function (a) {
    a.global = a.options = {
        gestureConfig: {
            tap: !0,
    ...
    a.os.plus && a.os.android && a.registerBack({
        ...
        name: "5+", index: 10, handle: function () {
            ...
            return d ? d.evalJS("mui.back();") : c.canBack(function (d) {
                if (d.canBack)b.history.back(); else {
                    var e = c.opener();
    ...
    a.ajax = function (d, e) {
        ...
        var h, l = f.accepts[g], m = {}, q = function (a, b) {
            m[a.toLowerCase()] = [a, b]
        }, r = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : b.location.protocol, s = f.xhr(r), t = s.setRequestHeader;
    ...
    var c = "mui-pull-top-pocket", d = "mui-pull-bottom-pocket", e = "mui-pull", f = "mui-pull-loading", g = "mui-pull-caption", h = "mui-icon", i = "mui-spinner", j = "mui-icon-pulldown", k = "mui-in", l = "mui-block", m = "mui-visibility", n = f + " " + h + " " + j, o = f + " " + h + " " + j, p = f + " " + h + " " + i, q = ['<div class="' + e + '">', '<div class="{icon}"></div>', '<div class="' + g + '">{contentrefresh}</div>', "</div>"].join(""), r = {
        init: function (b, c) {
    ...
    var e = "mui-scrollbar", f = "mui-scrollbar-indicator", g = e + "-vertical", h = e + "-horizontal", i = "mui-active", j = {
        ...
        init: function (b, c) {
            ...
            var f = isReturn = !1, g = this._getDirectionByAngle(d.angle);
            if ("left" === d.direction || "right" === d.direction ? this.options.scrollX ? (f = !0, this.moved || ("left" !== g && "right" !== g ? isReturn = !0 : (a.gestures.touch.lockDirection = !0, a.gestures.touch.startDirection = d.direction))) : this.options.scrollY && !this.moved && (isReturn = !0) : "up" === d.direction || "down" === d.direction ? this.options.scrollY ? (f = !0, this.moved || (a.gestures.touch.lockDirection = !0, a.gestures.touch.startDirection = d.direction)) : this.options.scrollX && !this.moved && (isReturn = !0) : isReturn = !0, f && (c.stopPropagation(), d.gesture && d.gesture.preventDefault()), !isReturn) {
                ...
                var j = Math.abs(d.deltaX), k = Math.abs(d.deltaY);
            ...
            if (this.x = a, this.y = b, this.scrollerStyle.webkitTransform = "translate3d(" + a + "px," + b + "px,0px)" + this.translateZ, this.parallaxElement && this.options.scrollY) {
                var c = b * this.options.parallaxRatio, d = 1 + c / ((this.parallaxHeight - c) / 2);
                d > 1 ? (this.parallaxImgStyle.opacity = 1 - c / 100 * this.options.parallaxRatio, this.parallaxStyle.webkitTransform = "translate3d(0px," + -c + "px,0px) scale(" + d + "," + d + ") " + this.translateZ) : (this.parallaxImgStyle.opacity = 1, this.parallaxStyle.webkitTransform = "translate3d(0px,-10px,0px) scale(1,1) " + this.translateZ)
            }
    ...
    var b = "mui-visibility", c = a.Scroll.extend(a.extend({
        handleEvent: function (a) {
    ...
    var c = "mui-slider", d = "mui-slider-group", e = "mui-slider-loop", f = "mui-slider-indicator", g = "mui-action-previous", h = "mui-action-next", i = "mui-slider-item", j = "mui-active", k = "." + i, l = "." + f, m = ".mui-slider-progress-bar", n = a.Scroll.extend({
        init: function (b, c) {
            this._super(b, a.extend(!0, {
                interval: 0,
                scrollY: !1,
            ...
            b._super(), b.wrapper.addEventListener("swiperight", a.stopPropagation), b.wrapper.addEventListener("scrollend", function () {
                ...
                b.slideNumber = b._fixedSlideNumber(), b.loop && (0 === b.slideNumber ? b.setTranslate(b.pages[1][0].x, 0) : b.slideNumber === b.itemLength - 3 && b.setTranslate(b.pages[b.itemLength - 2][0].x, 0)), c != b.slideNumber && a.trigger(b.wrapper, "slide", {slideNumber: b.slideNumber})
            }), b.wrapper.addEventListener("slide", function (c) {
                if (c.target === b.wrapper) {
                    var d = c.detail;
                    d.slideNumber = d.slideNumber || 0;
                    var e = b.scroller.querySelectorAll(k), f = d.slideNumber;
                    if (b.loop && (f += 1), !b.wrapper.classList.contains("mui-segmented-control"))for (var g = 0, h = e.length; h > g; g++) {
                        var i = e[g];
                    ...
                    if (l) {
                        ...
                        if (m.length > 0)for (var g = 0, h = m.length; h > g; g++)m[g].classList[g === d.slideNumber ? "add" : "remove"](j); else {
                            ...
                            if (n)n.innerText = d.slideNumber + 1; else for (var o = b.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = o.length; h > g; g++)o[g].classList[g === d.slideNumber ? "add" : "remove"](j)
                        }
                    }
                    c.stopPropagation()
                }
            ...
            if (this.scrollerWidth = this.itemLength * this.scrollerWidth, this.maxScrollX = Math.min(this.wrapperWidth - this.scrollerWidth, 0), this._super(), this.currentPage.x)this.slideNumber = this._fixedSlideNumber(); else {
    ...
    if (a.os.plus && a.os.android) {
        var c = "mui-plus-pullrefresh", d = "mui-in", e = "mui-block", f = a.Class.extend({
            init: function (a, b) {
        ...
        a.fn.pullRefresh = function (d) {
            ...
            return i ? g = a.data[i] : (i = ++a.uuid, e.setAttribute("data-pullrefresh-plus-" + h, i), b.body.classList.add(c), a.data[i] = g = new f(e, d)), g
        }
    }
}(mui, document), function (a, b, c, d) {
    var e = "mui-off-canvas-left", f = "mui-off-canvas-right", g = "mui-off-canvas-backdrop", h = "mui-off-canvas-wrap", i = "mui-slide-in", j = "mui-active", k = "mui-transitioning", l = ".mui-inner-wrap", m = a.Class.extend({
        init: function (b, d) {
            this.wrapper = this.element = b, this.scroller = this.wrapper.querySelector(l), this.classList = this.wrapper.classList, this.scroller && (this.options = a.extend(!0, {dragThresholdX: 10}, d), c.body.classList.add("mui-fullscreen"), this.refresh(), this.initEvent())
        }, refresh: function () {
            ...
            switch (b.type) {
                ...
                case"drag":
                    var c = b.detail;
                    this.startX ? this.lastX = c.move.x : (this.startX = c.move.x, this.lastX = this.startX), !this.isDragging && Math.abs(this.lastX - this.startX) > this.options.dragThresholdX && ("left" === c.direction || "right" === c.direction) && (this.slideIn && (this.scroller = this.classList.contains(j) ? this.offCanvasRight && this.offCanvasRight.classList.contains(j) ? this.offCanvasRight : this.offCanvasLeft : "left" === c.direction && this.offCanvasRight ? this.offCanvasRight : "right" === c.direction && this.offCanvasLeft ? this.offCanvasLeft : null), this.scroller && (this.startX = this.lastX, this.isDragging = !0, a.gestures.touch.lockDirection = !0, a.gestures.touch.startDirection = c.direction, this.scroller.classList.remove(k), this.offsetX = this.getTranslateX(), this._initOffCanvasVisible())), this.isDragging && (this.updateTranslate(this.offsetX + (this.lastX - this.startX)), c.gesture.preventDefault(), b.stopPropagation());
                    break;
                case"dragend":
                    if (this.isDragging) {
                        ...
                        if (this.slideIn) {
                            if (e = f >= 0 ? this.offCanvasRightWidth && f / this.offCanvasRightWidth || 0 : this.offCanvasLeftWidth && f / this.offCanvasLeftWidth || 0, this.openPercentage(e >= .5 && "left" === d ? 0 : e > 0 && .5 >= e && "left" === d ? -100 : e >= .5 && "right" === d ? 0 : e >= -.5 && 0 > e && "left" === d ? 100 : e > 0 && .5 >= e && "right" === d ? -100 : -.5 >= e && "right" === d ? 0 : e >= -.5 && "right" === d ? 100 : -.5 >= e && "left" === d ? 0 : e >= -.5 && "left" === d ? -100 : 0), 1 === e || -1 === e || 0 === e)return void this._dispatchEvent()
                        } else {
                            ...
                            this.openPercentage(e > 0 && .5 > e && "right" === d ? 0 : e > .5 && "left" === d ? 100 : 0 > e && e > -.5 && "left" === d ? 0 : "right" === d && 0 > e && e > -.5 ? 0 : .5 > e && "right" === d ? -100 : "right" === d && e >= 0 && (e >= .5 || c.flick) ? 100 : "left" === d && 0 >= e && (-.5 >= e || c.flick) ? -100 : 0), (1 === e || -1 === e) && this._dispatchEvent()
                        }
                    }
            }
    ...
    var e = "mui-control-item", f = "mui-segmented-control", g = "mui-control-content", h = "mui-bar-tab", i = "mui-tab-item", j = function (a, b) {
        ...
        if (j) {
            ...
            if (j && j.classList.add(n), j.hash && (m = c.getElementById(j.hash.replace("#", "")))) {
                ...
                if (!p) {
                    ...
                    a.trigger(m, a.eventName("shown", d), {tabNumber: Array.prototype.indexOf.call(t, m)}), b.detail && b.detail.gesture.preventDefault()
                }
            }
        }
    })
    ...
    var j = function (a) {
        this.element = a, this.classList = this.element.classList, this.handle = this.element.querySelector(h), this.init(), this.initEvent()
    };
    ...
    a.toast = function (b) {
        if (a.os.plus)plus.nativeUI.toast(b, {verticalAlign: "bottom"}); else {
    ...
    r.prototype.init = function () {
        ...
        this.each(function () {
            ...
            if ("range" === this.type && c.classList.contains("mui-input-range"))b.push("slider"); else {
            ...
            if (!g) {
                ...
                for (var h = 0, i = b.length; i > h; h++)this.setAttribute("data-input-" + b[h], g)
            }
        })
    }, a.ready(function () {
